...
ROLE_PERMISSIONS: Dict[Role, Set[Permission]] = {
    ...
    Role.VIEWER: {Permission.VIEW_REPORTS, Permission.EXPORT_DATA},
    Role.API_USER: {Permission.API_ACCESS, Permission.VIEW_REPORTS, Permission.EXPORT_DATA},
}
...
class AuthManager:
    ...
    def create_user(
        self, username: str, email: str, password: str, role: Role = Role.VIEWER, **metadata
    ) -> Optional[User]:
        """创建新用户
        ...
        user = User(id=user_id, username=username, email=email, role=role, metadata=metadata)
