...
from src.core.models import ESGMetrics, DEFAULT_SCORE
from src.core.compliance_checker import ComplianceChecker
from src.analysis.gap_analyzer import GapAnalyzer, GapResult
from src.fusion.ahp import AHPFusionEngine
from src.utils.html_sanitizer import sanitize_html, sanitize_for_markdown
from src.extractor.pdf_extractor import PDFExtractor, PDFNotFoundError
...
class TestBoundaryConditions(unittest.TestCase):
    ...
    def test_confidence_boundary_values(self):
        ...
        for confidence_dict, expected_level in test_cases:
            ...
            self.assertEqual(level, expected_level, f"置信度{confidence_dict}应该为{expected_level}")
