...
class ChannelAdvisor:
        ...
        "E": [
            {
                "channel_name": "年度ESG报告",
                "priority": "主渠道",
                "reason": "环境议题适合详细数据披露和进展汇报",
            },
            {
                "channel_name": "官网ESG专栏",
                "priority": "主渠道",
                "reason": "实时展示环境管理数据和可视化进展",
            },
            {
                "channel_name": "ESG评级回复",
                "priority": "辅助渠道",
                "reason": "回应评级机构对环境议题的专业问询",
            },
        ],
        "S": [
            {
                "channel_name": "年度ESG报告",
                "priority": "主渠道",
                "reason": "披露社会议题数据和员工相关指标",
            },
            {
                "channel_name": "员工大会",
                "priority": "主渠道",
                "reason": "直接向员工传达社会相关政策和举措",
            },
            {
                "channel_name": "社交媒体",
                "priority": "辅助渠道",
                "reason": "分享社会责任故事和员工成就",
            },
        ],
        "G": [
            {
            ...
            },
            {
                "channel_name": "股东大会",
                "priority": "主渠道",
                "reason": "向股东汇报治理变更和重要决策",
            },
            {
                "channel_name": "投资者路演",
                "priority": "辅助渠道",
                "reason": "阐述公司治理优势和投资者权益保护",
            },
        ],
    }
    ...
    def filter_channels_by_priority(
        self, channels: List[Dict[str, str]], priority: Optional[str] = None
    ) -> List[Dict[str, str]]:
        """按优先级筛选渠道
