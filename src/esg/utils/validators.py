...
def validate_percentage(value: Union[int, float, str], field_name: str = "百分比") -> Tuple[bool, str]:
    """验证百分比值的合法性
...
def validate_non_negative_number(value: Union[int, float, str], field_name: str = "数值") -> Tuple[bool, str]:
    """验证非负数值的合法性
...
def validate_emissions_value(value: Union[int, float, str], field_name: str = "排放量") -> Tuple[bool, str]:
    """验证碳排放量的合法性
