...
class HTMLSanitizer:
    ...
    DANGEROUS_TAGS: Set[str] = {
        ...
        'applet', 'meta', 'link', 'base', 'form', 'input', 'textarea',
        'button', 'select', 'option', 'optgroup', 'svg', 'math', 
        'noscript', 'template', 'slot', 'canvas', 'portal'
    }
    ...
    DANGEROUS_PROTOCOLS: Set[str] = {
        'javascript:', 'vbscript:', 'data:', 'mhtml:', 'file:', 'about:', 'blob:'
    }
    ...
    EVENT_ATTRIBUTES: Set[str] = {
        ...
        'onsubmit', 'onreset', 'onselect', 'onload', 'onunload', 'onerror',
        'onresize', 'onscroll', 'oncontextmenu', 'onbeforeunload', 'onbeforeprint',
        'onafterprint', 'onhashchange', 'onpageshow', 'onpagehide', 'onpopstate',
        'onstorage', 'ononline', 'onoffline', 'ondrag', 'ondragstart', 'ondragend',
        'ondragenter', 'ondragleave', 'ondragover', 'ondrop', 'oncopy', 'oncut',
        'onpaste', 'ontouchstart', 'ontouchmove', 'ontouchend', 'ontouchcancel'
    }
    ...
    def _sanitize_tags(cls, html: str) -> str:
        ...
        for dangerous_tag in cls.DANGEROUS_TAGS:
            ...
            content_pattern = re.compile(
                rf'<{dangerous_tag}\b[^>]*>.*?</{dangerous_tag}\s*>',
