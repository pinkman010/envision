    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'emissions_by_category': {
                k.value: v for k, v in self.emissions_by_category.items()
            },
...
class CarbonFootprintCalculator:
    ...
    def calculate(
        ...
        # 按范围分类计算
        scope1_sources = [
            s for s in self.emission_sources
            if s.category in [
...
INDUSTRY_BENCHMARKS = {
    ...
    'finance': {
        'carbon_intensity_median': 0.3,
        'carbon_intensity_best': 0.05,
        'scope3_ratio': 0.8
    }
}
